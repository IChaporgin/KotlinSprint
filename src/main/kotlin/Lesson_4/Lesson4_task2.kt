...
fun main() {
    ...
    println("Груз с весом $weightCargo1 кг и объемом $volumeCargo1 л соответствует категории \"AVERAGE\": ${(weightCargo2 > MIN_WEIGHT && weightCargo2 <= MAX_WEIGHT) && volumeCargo2  <= MAX_VOLUME}")
